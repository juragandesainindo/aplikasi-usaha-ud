            ...
            <form action="{{ route('periode-produksi.store') }}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tanggal_awal" value="{{ old('tanggal_awal') }}" placeholder=""
                            class="form-control float-right" id="reservation">
                    </div>
                    <div class="form-group">
                        <label>Tanggal Akhir</label>
                        <input type="text" name="tanggal_akhir" value="{{ old('tanggal_akhir') }}" placeholder=""
                            class="form-control">
                    </div>
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('periode-produksi.update',$item->id) }}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Tanggal Awal</label>
                        <input type="text" name="tanggal_awal" value="{{ $item->tanggal_awal }}" placeholder=""
                            class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Tanggal Akhir</label>
                        <input type="text" name="tanggal_akhir" value="{{ $item->tanggal_akhir }}" placeholder=""
                            class="form-control">
                    </div>
                </div>
                <div class="modal-footer">
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Periode - {{
                        $usaha->nama_usaha }}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('periode') }}"><i class="fas fa-backspace"></i>
                                Kembali</a></li>
                    </ol>
                </div>
            </div><!-- /.row -->
