                ...
                <div class="col-xl-8 stretch-card grid-margin">
                    <div class="card">
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table custom-table text-dark">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="../assets/images/faces/face5.jpg" class="me-2" alt="image" />
                                                Ina Curry
                                            </td>
                                            <td>
                                                <div class="d-flex">
                                        ...
                                        <tr>
                                            <td>
                                                <img src="../assets/images/faces/face7.jpg" class="me-2" alt="image" />
                                                Lida Fitzgerald
                                            </td>
                                            <td>
                                                <div class="d-flex">
                                        ...
                                        <tr>
                                            <td>
                                                <img src="../assets/images/faces/face9.jpg" class="me-2" alt="image" />
                                                Maria Ortiz
                                            </td>
                                            <td>
                                                <div class="d-flex">
                            ...
                            <a class="text-black d-block ps-4 pt-2 pb-2 pb-lg-0 font-13 font-weight-bold" href="#">Show
                                more</a>
                        </div>
                    </div>
                </div>
